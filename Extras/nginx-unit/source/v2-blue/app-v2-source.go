...
<head>
  <meta charset="utf-8">
  <title>Show me Headers! V2 Blue</title>
  <meta name="description" content="Version 2: A Simple application to show Hostname, IP Address and Request Headers">
  ...
  <style type="text/css">
	...
	// Show the text "version 2", this app can be used to show handling of different
